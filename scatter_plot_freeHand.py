...
def setupParserOptions():
	...
	parser.add_option("--inc",dest="inc",type="int", metavar="INT",
        ...
        parser.add_option("-s", action="store_true",dest="spi",default=False,
                help="Flag if text file is SPIDER format")
...
def scatter(data,lim,tilt,include,spider):
...
if __name__ == "__main__":
	...
	scatter(params['peaks'],params['lim'],tiltCenter,params['inc'],params['spi'])
